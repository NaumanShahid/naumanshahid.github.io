...
<div class="container-fluid row">
	...
	<div class="col" style="word-wrap:break-word;">
		...
		<a class="list-group-item" style="padding:2.5%;">Html Agility Pack and XPATH proved to be helpful in achieving this goal</a>
		<a class="list-group-item" style="padding:2.5%;">Data was logged in a background thread from KSE website after 5 minute intervals and trend graphs plotted to ease analysis</a>
